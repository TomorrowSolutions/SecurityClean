    ...
    public partial class init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ContractSecuredItems", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.InsertData(
                ...
                columns: new[] { "Id", "ContractId", "SecuredItemId" },
                values: new object[,]
                {
                    { 1, 1, 1 },
                    { 2, 1, 2 },
            ...
            migrationBuilder.InsertData(
                ...
                columns: new[] { "Id", "ContractId", "ServiceId" },
                values: new object[,]
                {
                    { 1, 1, 1 },
                    { 2, 1, 2 },
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ContractSecuredItems_ContractId",
                table: "ContractSecuredItems",
                column: "ContractId");
